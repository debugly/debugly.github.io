...
- git 修改全局 user.name 和 user.email
...
- 合并分支
  ...
  ```bash
  # merge branchname to current branchname
...
```bash
➜  ~ mdls /Users/qianlongxu/Desktop/SOHO-logo.685e6e1f.jpg 
_kMDItemDisplayNameWithExtensions      = "SOHO-logo.685e6e1f.jpg"
...
kMDItemDisplayName                     = "SOHO-logo.685e6e1f.jpg"
...
kMDItemFSLabel                         = 0
kMDItemFSName                          = "SOHO-logo.685e6e1f.jpg"
...
sips -s format jpeg ./201512/img201512272145-0.jpg -o ./201512/img201512272145-0.jpg
# 宽高最大不超过 1200像素
sips -Z 1200 *.jpg
# 将 png 后缀的图片文件，生成后缀为 jpg 的图片文件
find . -name "*.jpg" | awk -F / '{b=$0;sub(/png/,"jpg");printf "sips -s format jpeg %s -o %s\n",b,$0}' | bash
# 删除 png 后缀的文件
